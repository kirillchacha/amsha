(() => {
    ...
    (() => {
        ...
        function addTouchClass() {
            ...
            let arrow = document.querySelectorAll(".menu__arrow-submenu");
        ...
        function initSliders() {
            if (document.querySelector(".our-clients__slider")) {
                let ourClientsSlider = new swiper_core_Swiper(".our-clients__slider", {
                    ...
                    on: {
                        reachEnd: function() {
                            if (this.activeIndex === this.slides.length - 1) this.slideTo(0, 1e3);
                        }
                    }
                });
                let clickCount = 0;
                document.querySelector(".our-clients__slider").addEventListener("click", (function() {
                    clickCount++;
                    if (clickCount < 3) ourClientsSlider.slideNext(); else {
                        ourClientsSlider.slideTo(0, 1e3);
                        clickCount = 0;
                    }
                }));
            }
            if (document.querySelector(".slider-considering-top")) new swiper_core_Swiper(".slider-considering-top", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
            ...
            if (document.querySelector(".slider-considering-center")) new swiper_core_Swiper(".slider-considering-center", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
            ...
            if (document.querySelector(".slider-considering-bottom")) new swiper_core_Swiper(".slider-considering-bottom", {
                modules: [ Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 6,
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            let items = document.querySelectorAll(".items-choose__item");
            if (items.length > 0) {
                items.forEach((item => item.classList.remove("active-accordion")));
                items[0].classList.add("active-accordion");
            }
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const menuLinks = document.querySelectorAll(".menu__link, .menu-footer__link, .sub-menu__link");
